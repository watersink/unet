# This is an implementation of UNET from this paper [U-Net: Convolutional Networks for Biomedical Image Segmentation](https://arxiv.org/pdf/1505.04597.pdf)
...
![image]( https://https://github.com/watersink/unet/raw/master/image/network.jpg)
our changes:
...
###prepare data
the data is ISBI datasets,can be downloaded [here](http://brainiac2.mit.edu/isbi_challenge/),also we have added the dataset in the folder ISBI£¬
there are three .tif
...
<div>
<img width="400" height="300" src="https://github.com/watersink/unet/raw/master/image/000.tif"/>
<img width="400" height="300" src="https://github.com/watersink/unet/raw/master/image/000.jpg"/>
</div>
